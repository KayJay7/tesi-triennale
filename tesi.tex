...
Quindi in un'applicazione reale non c'è un vero risultato in output, un qualcosa di cui misurare il throughput. Al massimo si possono misurare le regole eseguite, ma quelle sono legate al tick che è impostato manualmente.
...
Quindi anche questo dato è stato considerato non
