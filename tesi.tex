...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \matrix [matrix,row sep=2.2em,column sep=2em] {
            ...
            \node[circle, draw, label={above:(prev.)}](pa02){$\text{\lstinline{ext.a0_2}}$};     &
            \node[circle, draw, label={above:(prev.)}](pa12){$\text{\lstinline{ext.a1_2}}$};     &
            \node[circle, draw, label={above:(prev.)}](pa22){$\text{\lstinline{ext.a2_2}}$};     &
            \node[circle, draw, label={above:(prev.)}](pa32){$\text{\lstinline{ext.a3_2}}$};   
            \\
        ...
        \graph[nodes={circle, draw, label={below:(tutti)}}]{
            ns/\lstinline{ext.start} [below=2.2em of sa],
        };
